...
{
	if ((*map)[(int)vec->posy][(int)(vec->posx + vec->dirx * vec->movespeed)] == '0')
		vec->posx += vec->dirx * vec->movespeed;
	if ((*map)[(int)(vec->posy + vec->diry * vec->movespeed)][(int)vec->posx] == '0')
...
{
	if ((*map)[(int)vec->posy][(int)(vec->posx + vec->planex * vec->movespeed)] == '0')
		vec->posx -= vec->planex * vec->movespeed;
	if ((*map)[(int)(vec->posy + vec->planey * vec->movespeed)][(int)vec->posx] == '0')

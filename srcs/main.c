...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/18 18:52:09 by nayache           #+#    #+#             */
/*   Updated: 2021/02/18 21:45:23 by nayache          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

static int	parse(int fd, t_list *token, t_info *info)
{
...
static int	init_buffer(t_info *info)
{
	int i;
...
static void	start_display(t_info *info)
{
	int	width_max;
	int	height_max;
...
static int	init_game(t_info *info, char *file)
{
	t_list	*token;
	int		fd;
	...
	if ((token = malloc(sizeof(t_list))) == NULL)
